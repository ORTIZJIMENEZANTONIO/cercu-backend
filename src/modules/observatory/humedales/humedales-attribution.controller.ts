...
import * as svc from './humedales-attribution.service';

// Helper para asegurar que el observatorio en la URL es 'humedales'.
// Las tablas de tiers/contributors son humedales-only; cualquier otra
// observatory en la ruta debe rechazarse.
function assertHumedales(req: Request) {
  if (req.params.observatory !== 'humedales') {
    const e: any = new Error('Estos recursos solo existen para humedales');
    e.statusCode = 404;
    throw e;
  }
}
